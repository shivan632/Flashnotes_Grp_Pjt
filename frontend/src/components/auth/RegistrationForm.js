            ...
            <div class="max-w-md w-full space-y-8 animate-fadeIn">
                ...
                <form id="registerForm" class="mt-8 space-y-5" onsubmit="return false;">
                    ...
                    <div class="flex items-center space-x-2 py-2">
                        <input type="checkbox" 
                               ...
                               required>
                        <label for="termsCheckbox" class="text-sm text-[#9CA3AF]">
                            I agree to the 
                            <a href="#" class="text-[#60A5FA] hover:text-[#3B82F6] transition-colors font-medium">Terms of Service</a> 
                            and 
                            <a href="#" class="text-[#60A5FA] hover:text-[#3B82F6] transition-colors font-medium">Privacy Policy</a>
                        </label>
                    </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-2 bg-[#1F2937] text-[#9CA3AF]">or</span>
                    </div>
                </div>
                ...
                <p class="text-center text-sm text-[#9CA3AF]">
                    ...
                    <a href="#/login" class="text-[#60A5FA] hover:text-[#3B82F6] transition-colors font-semibold hover:underline">
                        Sign in
                    </a>
                </p>
            </div>
...
export function setupRegistrationForm() {
    ...
    newForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            localStorage.setItem('pendingUserName', name);  // <-- ADD THIS
