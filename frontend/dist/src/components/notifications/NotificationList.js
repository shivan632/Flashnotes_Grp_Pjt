...
// Notification List Component - Enhanced UI
...
export function NotificationList({ notifications, onMarkRead, onDelete, onMarkAllRead }) {
    ...
    return `
        <div class="bg-gradient-to-br from-[#1F2937] to-[#111827] rounded-2xl border border-[#374151] overflow-hidden">
            <!-- Header -->
            <div class="flex items-center justify-between p-5 border-b border-[#374151] bg-gradient-to-r from-[#1F2937] to-[#111827]">
                ...
                <div class="flex items-center gap-3">
                    ${unreadCount > 0 ? `
                        <button id="markAllReadBtn" class="text-xs text-[#60A5FA] hover:text-[#3B82F6] transition-all duration-300 flex items-center gap-1 group">
                    ...
                    ` : ''}
                    <div class="bg-gradient-to-r from-[#3B82F6] to-[#A78BFA] text-white text-xs font-bold px-2.5 py-1 rounded-full shadow-md">
            ...
            <!-- Footer Actions -->
            <div class="p-3 border-t border-[#374151] bg-[#111827]/50 flex justify-center">
                <button id="clearAllNotificationsBtn" class="text-xs text-red-400 hover:text-red-500 transition-all duration-300 flex items-center gap-1 group px-3 py-1.5 rounded-lg hover:bg-red-500/10">
