...
import { getUserScores, getLeaderboard, getUserAchievements, getQuickStats } from '../services/scoreService.js';
...
export async function ScorePage() {
    ...
    try {
        ...
        const [scoresData, leaderboardData, achievementsData, quickStats] = await Promise.all([
            getUserScores(),
                    ...
                    <main class="container mx-auto px-4 py-8">
                            ...
                            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                                ...
                                <div class="bg-gradient-to-br from-[#1F2937] to-[#111827] rounded-2xl px-6 py-3 border border-[#374151]">
                                    <div class="flex items-center gap-2">
                                        <div class="text-2xl font-bold text-[#3B82F6]">${Math.round(stats.averageScore || 0)}%</div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
                            ${ScoreCard({ 
                                ...
                                change: stats.averageScore > 70 ? 5 : -2
                            })}
                            ${ScoreCard({ 
                                title: 'Quizzes Taken', 
                        ...
                        <div class="bg-gradient-to-br from-[#1F2937] to-[#111827] rounded-2xl shadow-xl p-6 border border-[#374151] animate-fadeInUp" style="animation-delay: 0.4s">
                            <div class="flex items-center justify-between mb-6">
                                ...
                                <div class="bg-[#111827] px-3 py-1.5 rounded-full">
                                    <span class="text-sm text-[#60A5FA] font-medium">${achievementsData.totalEarned}/${achievementsData.totalAvailable} earned</span>
                                </div>
                            </div>
